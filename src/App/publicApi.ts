...
/** Register */
publicApi.post(`${globalEnv.PREFIX}/register`, upload.array('image', 1) ,UserController.Register)
...
publicApi.put(`${globalEnv.PREFIX}/updateUser`, upload.array('image', 1),Jwt.jwtValidator, UserController.UpdateUser)
